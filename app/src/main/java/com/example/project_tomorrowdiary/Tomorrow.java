...
public class Tomorrow extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_tomorrow,container,false);

        TextView nextday= (TextView) viewGroup.findViewById(R.id.nextday);
        Button btn = (Button)viewGroup.findViewById(R.id.go_write_btn);
